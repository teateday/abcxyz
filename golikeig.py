...
def INSTAGRAM():
    ...
    for data in checkurl1_2['data'] :
        ...
        print(f'\033[1;35m[TAT07] => \033[1;36m[{i}] \033[1;32mTài Khoản: \033[1;93m{usernametk} | \033[1;32mTrạng Thái:\033[1;93m {STATUS[-1]}')
       
        i += 1
    print('\033[97m════════════════════════════════════════════════')
    choose = int(input('\033[1;35m[TAT07] => Nhập Tài Khoản : '))
    ...
    if choose >=1 or choose <= len(user_INS) :
        ...
        if checkfile2 == False:
            banner()
            cookieX = input(Fore.GREEN+'\033[1;35m[TAT07] => Nhập Cookie Instagram: ')
        ...
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
        choose = int(input(Fore.RED+'\033[1;37m[TAT07] => \033[1;35mMày Cần Làm Bao Nhiêu Job: '))
        headerINS = {
                'accept': '*/*',
        ...
        DELAY = int(input(Fore.RED+'\033[1;37m[TAT07] => \033[1;35mNhập Delay : '))
        print("\033[97m════════════════════════════════════════════════")
                ...
                if nos['status'] == 200:
                    ...
                    if job_type == 'follow':
                        ...
                        if '"status":"ok"' in response:
                            ...
                            print(Fore.RED + "ACC BỊ YẾU SINH LÍ")
                        elif '"status":"fail"' in response and '"require_login":true' in response:
                            print('Xuất Tinh Rồi! Tôi Rất Tiếc [DIE COOKIE]')
...
\033[1;37m╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝
\033[1;31m────────────────────────────────────────────────────────────
\033[1;31m[\033[1;37mTAT07\033[1;31m] \033[1;37m=> \033[1;33mTOOL GOLIKE INSTAGRAM
...
if checkfile == False:
    AUTHUR = input(Fore.GREEN+'\033[1;37m[TAT07] => \033[1;32mNHẬP AUTHOR: ')
...
if checkurl1['status']== 200 :
        ...
        print(Fore.GREEN+'\033[1;37m[TAT07] => \033[1;35mĐại Gia: '+Fore.YELLOW+username)
        print(Fore.GREEN+'\033[1;37m[TAT07] => \033[1;35mTài Sản: '+Fore.YELLOW+str(coin))
        print(Fore.RED+'\033[97m════════════════════════════════════════════════')
        print("\033[1;37m[TAT07] => \033[1;33mNhấn [1] Để Vào Tool")
        print(Fore.RED+'\033[1;37m[TAT07] => \033[1;32mNhập [2] Để Xóa Authorization Hiện Tại')
        choose = int(input(Fore.WHITE+'\033[1;35m[TAT07] => Tao Mời Mày Chọn : '))
        if choose == 1:
            os.system('cls' if os.name== 'nt' else 'clear')
            LIST()
            username = checkurl1['data']['username']
            coin = checkurl1['data']['coin']
            user_id = checkurl1['data']['id']
            print(Fore.GREEN+'\033[1;33m[TAT07] =>  \033[1;35mTài Khoản : '+Fore.YELLOW+username)
            print(Fore.GREEN+'\033[1;33m[TAT07] =>  \033[1;35mTổng Tiền : '+Fore.YELLOW+str(coin))
            print(Fore.RED+'\033[97m════════════════════════════════════════════════')
            INSTAGRAM()
        elif choose == 2:
                os.remove('user.txt')
else:
    print(Fore.RED+'\033[1;35m[TAT07] => ĐĂNG NHẬP THẤT BẠI [KIỂM TRA LẠI AUTHOR]')
    os.remove('user.txt')