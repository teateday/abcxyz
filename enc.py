...
╚══██╔══╝██╔══██╗╚══██╔══╝██╔═████╗╚════██║
   ...
   ██║   ██║  ██║   ██║   ╚██████╔╝  ██║   
   ╚═╝   ╚═╝  ╚═╝   ╚═╝    ╚═════╝   ╚═╝
  Copyright By: @TAT07-ExE Version : 2.0                                           
──────────────────────────────────────────            
[</>] Box Tele: https://t.me/zwincltx
[</>] Web CLTX: https://kingtele.sbs
[</>] ADMIN: TAT07 - ExE
...
def main():
    ...
    print()
    key = Write.Input("[</>] Khều Donate [ VCB - 1039910788 ] [Nhấn ENTER]", Colors.red_to_yellow, interval=0.005)
